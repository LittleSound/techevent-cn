...
<template>
  <div mx-auto px-4 pb-16 max-w-4xl>
    <TheHeader />
    ...
    <div px-1>
      ...
      <template v-if="view === 'calendar'">
        <CalendarView mt-4 :events="filteredAnyTime" :initial-date="calendarStart" />
      </template>

      <template v-else>
        <div v-if="filtered.length" mt-2 flex="~ col gap-8">
        ...
        <div v-else mt-12 text-center op60>
      ...
      <footer text-sm mt-16 pt-6 text-center border-t border-gray-100 op50 dark:border-gray-800>
        以开源精神维护 · 由社区共同补充 ·
        <a :href="newEventUrl" target="_blank" rel="noopener" text-teal-600 hover:underline>
          提交活动
        </a>
